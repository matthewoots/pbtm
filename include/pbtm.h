...
class pbtm_class
{
    private:
        ...
        /** @brief Subscribers **/
        ros::Subscriber _pos_sub, _vel_sub, _waypoint_sub, _state_sub, _flat_ref_enu_sub;
        /** @brief Publishers **/
        ros::Publisher _pose_nwu_pub, _local_pos_raw_pub, _log_path_pub, _att_rate_pub, _ref_enu_pub;
